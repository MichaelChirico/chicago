...
BiocStyle::markdown()
knitr::opts_chunk$set(dev = "png", fig.ext = "png", dev.args = list(type = "cairo"))
```
...
```{r, message=FALSE, eval=requireNamespace("GenomicInteractions", quietly=TRUE) && requireNamespace("GenomicRanges", quietly=TRUE)}
...
```{r, message=FALSE, eval=requireNamespace("AnnotationHub", quietly=TRUE)}
...
```{r, eval=requireNamespace("GenomicInteractions", quietly=TRUE)}
...
```{r, eval=requireNamespace("GenomicInteractions", quietly=TRUE) && requireNamespace("AnnotationHub", quietly=TRUE)}
...
```{r, eval=requireNamespace("AnnotationHub", quietly=TRUE)}
hs["AH23254"]$genome
```
